...
One of the busiest internation air passenger airports in North America ant the sixth busiest airpots in United States with close to 60 million passengers usint the facility a year (2016 data). 
The airport features sixt passenger terminals and four runways.

The focus of the research is to determine the effects of airlines' performance on airport gate utilization on airport financials. More than ninty airlines operate at JFK Airport using the more than 128 gates across six terminals.
