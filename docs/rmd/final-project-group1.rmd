...
# Proposed Plan
The focus of this project will be on one United States major airports - either John F. Kennedy Airport in New York or San Francisco Airport (SFO) depending on the data availability. The study will analyze airline gate operations performance measures over a 1997 to 2008 of publicly available data from bureau of transportation statistics. 
