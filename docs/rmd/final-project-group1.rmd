...
The study will look at John F. Kennedy International Airport (JFK).  JFK Airport is one of the busiest airports in the United States with close to 60 million passengers (2016 data).  More than 90 airlines operate at JFK Airport using the more than 128 gates across six terminals.
