...
For the development of this project we are using CRoss-Industry Standard Process for Data Mining (CRISP-DM) was developed by Daimler Chrysler (then Daimler-Benz), SPSS (then ISL) and NCR in 1999.

```{r fig.width=6,echo=FALSE}
library(png)
library(grid)
img <- readPNG("../../images/CRISP-DM_Process_Diagram.png")
 grid.raster(img)
```
\newpage
