...
# Introduction
This study will look at John F. Kennedy International Airport (JFK Airport). JFK Airport is located in the neighborhood of Jamaica in the borough of Queens, in New York, 30km (16 Miles) southeast of Midtown Manhattan.
One of the busiest international air passenger airports in North America and the sixth busiest airpots in United States with close to 60 million passengers using the facility each year. 
The airport features six passenger terminals and four runways, the over ninty airline carriers operate at airport using the more than 128 gates across the six passenger terminals.


![alt text](https://binged.it/2sWBsfF)



United State airline performance information from an eleven-year span has been retrieved from airlines transportation database. The datasets are from the year 1997 through to the year 2008.
...
```{r crisp-dm, fig.cap = "CRISP-DM Process Diagramm.", fig.align = "center", out.width = "\\textwidth", fig.pos = "!h"}
knitr::include_graphics("../../images/CRISP-DM_Process_Diagram.png", dpi = 800)
```
